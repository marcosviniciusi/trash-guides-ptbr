#!/usr/bin/env bash
# Usage: ./add_groups_premium.sh GroupName1 GroupName2 GroupName3
# Adds release groups to custom-us-group-tier-premium.json
# negate=false, required=false
# Validates unique "name" field before adding
...
# Validate unique names within the file itself (warn if duplicates already exist)
