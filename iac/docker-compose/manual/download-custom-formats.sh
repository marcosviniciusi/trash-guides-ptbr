...
download_format 'custom-pt-br-x264.json'
download_format 'custom-pt-br-x265.json'
download_format 'custom-pt-br-h264.json'
download_format 'custom-pt-br-h265.json'
